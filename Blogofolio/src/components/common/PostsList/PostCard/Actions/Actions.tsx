...
import {deleteCardAction, selectCardAction, updateCardAction} from "../../../../../store/reducers/selectedCardReducer";
...
const Actions:FC<AllActionsProps> = ({post, variant, onClick}) => {
    ...
    const handleDeletePost = () => {
        dispatch(deleteCardAction(post));
    ...
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.iconsBlock}>
                <div className={styles.iconsLeftPartBlock}>
                    <div className={styles.like}>
                        <ActionItem className={`${isDarkTheme ? styles.dark : ""} ${styles.button}`} onClick={handleLikePost}>
                        ...
                        <p className={`${isDarkTheme ? styles.numberDark : ""} ${styles.number}`}>{post.likes}</p>
                    </div>
                    <div className={styles.like}>
                        <ActionItem className={`${isDarkTheme ? styles.dark : ""} ${styles.button}`} onClick={handleDislikePost}>
                            <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className={`${isDarkTheme ? styles.numberDark : ""} ${styles.number}`}>{post.dislikes}</p>
                    </div>
                </div>
                <div className={styles.iconsRightPartBlock}>
                    <ActionItem className={`${isDarkTheme ? styles.dark : ""} ${styles.button}`} onClick={handleAddToFavoritePost}>
                        {post.favorite ? <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path className={`${isDarkTheme ? styles.dark : ""} ${styles.button}`}  d="M15 20C14.795 20 14.592 19.937 14.419 19.813L8 15.229L1.581 19.813C1.277 20.032 0.875 20.062 0.542 19.89C0.209 19.718 0 19.375 0 19V3C0 1.346 1.346 0 3 0H13C14.654 0 16 1.346 16 3V19C16 19.375 15.791 19.718 15.458 19.89C15.313 19.963 15.156 20 15 20Z"/>
                    ...
                    <DropdownList onClick={onClick} onDelete={handleDeletePost}/>
                </div>
            </div> :
                <div className={styles.iconsBlockContent}>
                    <div className={styles.iconsPartBlockContent}>
                        <ActionItem className={`${post.like ? styles.active : ""} ${styles.buttonLikeContent}`} onClick={handleLikePost}>
                            <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                                <path className={styles.svgSelectedContent} d="M18.292 19.15C18.218 19.636 17.794 20 17.292 20H17.28H7V10.212L10.608 2.094C11.415 2.352 12 3.108 12 4V8C12 8.552 12.447 9 13 9H18.674C18.728 9.002 18.78 9.003 18.832 9.011C19.097 9.051 19.33 9.192 19.488 9.407C19.646 9.622 19.712 9.885 19.672 10.148L18.292 19.15ZM5 20H3C2.449 20 2 19.551 2 19V12C2 11.448 2.449 11 3 11H5V20ZM21.099 8.22C20.623 7.575 19.925 7.154 19.132 7.033C18.972 7.009 18.814 7.004 18.66 7H14V4C14 1.794 12.206 0 10 0C9.605 0 9.247 0.233 9.086 0.593L5.35 9H3C1.346 9 0 10.345 0 12V19C0 20.654 1.346 22 3 22H17.269H17.304C18.776 22 20.048 20.909 20.269 19.451L21.648 10.45C21.77 9.657 21.574 8.866 21.099 8.22Z" />
                            </svg>
                        </ActionItem>
                        <ActionItem className={`${post.dislike ? styles.activeDislike : ""} ${styles.buttonDislikeContent}`} onClick={handleDislikePost}>
                            <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={`${styles.iconsPartBlockContent}`}>
                        <ActionItem className={`${post.favorite ? styles.active : ""} ${styles.buttonBookContent}`} text="Add to favorites" onClick={handleAddToFavoritePost}>
