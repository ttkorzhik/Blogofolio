...
import SearchService, {Results} from "../services/searchService";
...
interface PaginationContextValue {
    ...
    handleGetPaginationParams: (callback: () => Promise<Results>) => void,
    pageLimit: number
}
...
const PaginationProvider: FC<WithChildren> = ({ children }) =>  {
    ...
    const handleGetPaginationParams = async (callback: () => Promise<Results>) => {
